...
class GazeDataset(torch.utils.data.dataset.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 读取text
        text = head_data.get('text', img_data.get('text', ""))
        ...
        if self.split == "train":
            ...
            return img, bbox_norm, gazex_norm, gazey_norm, torch.tensor(inout), height, width, heatmap, text
        else:
            return img, bbox_norm, gazex_norm, gazey_norm, torch.tensor(inout), height, width, text
