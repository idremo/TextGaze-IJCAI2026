...
# 配置参数
JSON_INPUT_PATH = '/data/sjh/EyeProject/DataSets/videoattentiontarget/train_preprocessed.json'
JSON_OUTPUT_PATH = '/data/sjh/EyeProject/DataSets/videoattentiontarget_Qwen_En/train_preprocessed_new.json'
IMAGE_ROOT = "/data/sjh/EyeProject/DataSets/videoattentiontarget/"
